    ...
    <div class="container-section">
      <div class="stacked-content">
        <div class="dual-grid single-column">
          <div class="top-holder replace-this-content"><div class="inter-div-content-area">{${serviceboxes41}_content93:content global="false"}</div></div>
        </div>
        <div class="w-layout-grid grid-6 service-icons">
          <div class="card first">
            ...
            <div class="card-bottom-info">
              <div class="card-description animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
                <h3 class="heading-9">{${serviceboxes41}_text22:text global="false"}</h3>
          ...
          <div class="card second">
            ...
            <div class="card-bottom-info">
              <div class="card-description animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
                <h3 class="heading-8">{${serviceboxes41}_text23:text global="false"}</h3>
          ...
          <div class="card third">
            ...
            <div class="card-bottom-info">
              <div class="card-description animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
                <h3 class="heading-7">{${serviceboxes41}_text24:text global="false"}</h3>
          ...
          <div class="card">
            ...
            <div class="card-bottom-info">
              <div class="card-description animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
                <h3 class="heading-6">{${serviceboxes41}_text25:text global="false"}</h3>
                <div class="body-display small replace-this-text">{${serviceboxes41}_div74:text global="false"}</div>
              </div>
              <div class="card-hover-link animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
                <div href="#" class="underline-hover-link dark">
                  <div class="subtitle-2 replace-this-text">{${serviceboxes41}_div75:text global="false"}</div>
                  <div class="hover-line-2">
                    <div class="hover-line-fill-2"></div>
                  </div>
                </div>
...
// This is the start of the fifty-fifty-image-left
    ...
    <div class="w-layout-grid grid-7">
      ...
      <div id="w-node-_0fa69d76-c691-c517-a66d-bb3c1c7cfd1c-bf3dcddd" class="grid-child-right animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
        <div class="individual-block replace-this-content"><div class="inter-div-content-area">{${fiftyfiftyimageleft}_content94:content global="false"}</div></div>
      </div>
    </div>
  </section>
      <!-------------------------------------------------------------------------------------
    ...
    <div class="container-section">
      <div class="padding-inner">
        <div class="drag-drop-section">
          <div class="replace-this-content second animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom"><div class="inter-div-content-area">{${workboxes21}_content95:content global="false"}</div></div>
        </div>
        <div class="w-layout-grid works-grid">
          <div class="work-link animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
            ...
            <div class="work-content">
              <p class="work-title">{${workboxes21}_text26:text global="false"}</p>
            ...
            <div class="content-parent">
              <div class="content-wrapper replace-this-content"><div class="inter-div-content-area">{${workboxes21}_content96:content global="false"}</div></div>
            </div>
          ...
          <div class="work-link animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
            ...
            <div class="work-content">
              <p class="work-title">{${workboxes21}_text27:text global="false"}</p>
              <div class="main-button">
                <div class="replace-this-button"><div class="button-wrap">{${workboxes21}_button91:button global="false"}</div></div>
                <div class="scroll-down-line"></div>
              </div>
            </div>
            <div class="work-background"></div>
            <div class="content-parent">
              <div class="content-wrapper replace-this-content"><div class="inter-div-content-area">{${workboxes21}_content97:content global="false"}</div></div>
            </div>
          </div>
        </div>
        <div class="cta-block-2 animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
          <div>
            <p class="ctas-title">{${workboxes21}_text28:text global="false"}</p>
          </div>
          <div class="button-hold">
            <div class="replace-this-button"><div class="button-wrap">{${workboxes21}_button92:button global="false"}</div></div>
          </div>
        </div>
      </div>
    </div>
...
// This is the start of the icons-3-2
    ...
    <div class="div-case-mixture">
      <div class="div-married-think">
        <div class="top-area-content replace-this-content"><div class="inter-div-content-area">{${icons32}_content98:content global="false"}</div></div>
      </div>
      <div class="div-official-thousand">
        ...
        <div class="div-lips-built animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom"><div class="img-finger-strike">{${icons32}_image12:image global="false"}</div>
          <h4 class="h3-excellent-storm">{${icons32}_text39:text global="false"}</h4>
          <p class="p-onto-nearer">{${icons32}_text40:text global="false"}</p>
        </div>
      </div>
    </div>
  </section>
...
// This is the start of the fifty-fifty-image-right
    ...
    <div class="w-layout-grid grid-7">
      <div id="w-node-_4d9e44b7-233b-f3c1-2883-567343e59db6-bf3dcddd" class="grid-child-right gray animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
        <div class="individual-block replace-this-content"><div class="inter-div-content-area">{${fiftyfiftyimageright}_content99:content global="false"}</div></div>
      </div>
...
// This is the start of the image-boxes-4-1
    ...
    <div class="theme-padding">
      <div class="top-drag-drop animate-this-left" data-aos="fade-right" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
        <div class="content-holder-images replace-this-content"><div class="inter-div-content-area">{${imageboxes41}_content100:content global="false"}</div></div>
      </div>
      <div class="w-layout-grid image-boxes">
        ...
        <div id="w-node-_2aa01c80-db73-774c-d518-78e0fc7d97a1-bf3dcddd" class="individual-image-box animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
          <div class="content-overlay no-pointer-events">
            <div class="content-overlay-portion allow-pointer-events">
              <h4 class="heading-10">{${imageboxes41}_text47:text global="false"}</h4>
              <p class="white-text-images">{${imageboxes41}_text48:text global="false"}</p>
            </div>
          ...
          <div class="div-deeply animate-this-right" data-aos="fade-left" data-aos-delay="000" data-aos-anchor-placement="center-bottom">
            <div class="div-pretty allow-pointer-events">
              <div class="div-block-6">
                <div class="content-transparent replace-this-content"><div class="inter-div-content-area">{${fiftyfiftyblurredbox}_content101:content global="false"}</div></div>
              </div>
            </div>
          </div>
        </div>
...
// This is the start of the prebuilt-footer
    ...
    <div class="div-jungle-soap">
      <div class="div-surprise-nest">
        <h4 class="h5-scene-carbon replace-this-text">{${prebuiltfooter}_text49:text global="false"}</h4>
        <div class="div-national-gasoline">
          <ul role="list" class="ul-machinery-between">
            <li class="li-occur-both"><div class="img-desert-situation">{${prebuiltfooter}_image19:image global="false"}</div><span class="span-ahead-observe replace-this-text">8502 Preston Rd. Inglewood, Maine 98380, USA</span></li>
            <li class="li-local-clean"><div class="img-desert-situation">{${prebuiltfooter}_image20:image global="false"}</div><span class="span-ahead-observe replace-this-text">support@rareblocks.xyz</span></li>
          </ul>
        </div>
      </div>
      ...
      <div class="div-exist-born">
        <div class="div-block-8">
          ...
          <p class="a-waste-victory">{${prebuiltfooter}_text51:text global="false"}</p>
          <p class="a-waste-victory">{${prebuiltfooter}_text52:text global="false"}</p>
        </div>
        <p class="p-bicycle-desert">{${prebuiltfooter}_text53:text global="false"}</p>
      </div>
    </div>
  </section>
      <!-------------------------------------------------------------------------------------
